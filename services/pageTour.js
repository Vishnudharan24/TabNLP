...
const TOUR_STEPS = {
    ...
    data: [
        ...
        STEP('[data-tour="report-config-panel"]', 'Data Panel (Right Sidebar)', 'When you are in report editing, this panel is the core control center for selecting fields, configuring filters, chart setup, and style options.'),
        STEP('[data-tour="datapanel-filters-section"]', 'Filter Selection Area', 'This section manages chart-level filters. Add filters, choose operators, and scope each visual independently from global filters.'),
        STEP('[data-tour="datapanel-filter-list"]', 'Filter Rows', 'Each filter row lets you pick a column, operator, and value/range. Use this for precise slicing and focused narrative visuals.'),
        STEP('[data-tour="datapanel-field-mapping-section"]', 'Field Selection Workflow', 'This section maps dataset fields to chart roles (dimension, measure, hierarchy, color, size). Correct mapping drives chart correctness.'),
        STEP('[data-tour="datapanel-available-fields-panel"]', 'Available Fields', 'Expand this panel to browse source columns and semantic measures before assigning them to chart roles.'),
        STEP('[data-tour="datapanel-field-search"]', 'Field Search', 'Use search to find columns quickly across large schemas and avoid manual scrolling.'),
        STEP('[data-tour="datapanel-field-groups"]', 'Type Grouping', 'Columns are grouped by category/time/number/id to guide valid chart-role selection and reduce configuration errors.'),
        STEP('[data-tour="datapanel-chart-setup-roles"]', 'Role Mapping', 'Assign fields into role buckets. For example: X-axis as dimension, Y-axis as measure, optional legend/color breakdown, and hierarchy levels.'),
    ],
    'source-config': [
    ...
    report: [
        ...
        STEP('[data-tour="report-settings-modal"]', 'Settings Popup', 'The tour opens this popup for you. This modal contains report-level appearance and sharing actions.'),
        STEP('[data-tour="report-settings-share-link"]', 'Share Link Button', 'Use this button to generate and copy a viewer link. Shared users can open the report in read-only mode.'),
        ...
        STEP('[data-tour="datapanel-filters-section"]', 'Chart Filter Setup', 'Inside the data panel, configure visual-level filters to control each chart without changing all visuals.'),
        STEP('[data-tour="datapanel-field-mapping-section"]', 'Field Mapping Setup', 'Map your fields carefully—this directly determines axes, groups, hierarchies, and measure calculations.'),
    ],
    'report-shared': [
    ...
    'templates-map': [
        ...
        STEP('[data-tour="templates-map-first-row"]', 'How to Map a Field', 'Each row is one required template field. Start row-by-row and map the most critical business fields first.'),
        STEP('[data-tour="templates-map-first-trigger"]', 'Open Field Dropdown', 'Click this control to open the selectable column list for the current required template field.'),
        STEP('[data-tour="templates-map-first-search"]', 'Search Inside Dropdown', 'Use this search to quickly find matching source columns by name or type in wide datasets.'),
        STEP('[data-tour="templates-map-first-options"]', 'Select Best Match', 'Pick the closest semantic match. If unsure, choose the business-equivalent column first and validate in generated charts.'),
